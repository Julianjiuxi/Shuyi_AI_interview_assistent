...
export const people: Person[] = [
  ...
  {
    id: 'meizhen', name: 'Lin Meizhen', chinese: '林美珍', years: '1954–', status: 'Living', role: 'Storyteller · Grandmother', relation: 'Spouse of Zhao Guowei', color: '#A54B3F', avatar: '/lin-meizhen-portrait.png',
    ...
    voice: {
      ...
      src: '/generated/meizhen-family-letter-zh-a.mp3',
