...
export const DICT: Record<UILang, Record<string, string>> = {
  'en-US': {
    ...
    'chat.send': 'Send',
    'chat.call.start': 'Start a call',
    'chat.call.title': 'Talking with ShuYi AI interviewer · oral history mode',
    'chat.call.headphone': '🎧 Headphones recommended to eliminate speaker echo',
    'chat.call.hangup': '📞 Hang up',
    'chat.call.requestMic': 'Requesting microphone…',
    'chat.call.initAudio': 'Initializing audio capture…',
    'chat.call.connect': 'Connecting to voice service…',
    'chat.call.init': 'Initializing session…',
    'chat.call.ready': 'Ready. Start speaking…',
  ...
  'zh-CN': {
    ...
    'chat.call.title': '正在与 ShuYi AI 访谈员通话 · 口述历史模式',
    'chat.call.headphone': '🎧 建议戴上耳机，可完全消除扬声器回声',
    'chat.call.hangup': '📞 挂断',
    'chat.call.requestMic': '请求麦克风…',
    'chat.call.initAudio': '初始化音频采集…',
    'chat.call.connect': '连接语音服务…',
    'chat.call.init': '会话初始化中…',
    'chat.call.ready': '会话已就绪，请开始说话…',
